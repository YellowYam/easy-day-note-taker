# Easy Day Note Taker [![License](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
  ...
  ***
  ...
  ```
  $ git clone git@github.com:YellowYam/easy-day-note-taker.git
  $ cd ../path/to/the/file
  $ npm install
  ``` 
